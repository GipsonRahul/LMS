    ...
    get()
      .then((response) => {
        ...
        formData = {
          ...
          RequesterId: response.Requester.Id,
          LeaveTypeId: response.LeaveType.Id,
          From: from,
          To: to,
        ...
        this.oldLeaveTypeId = response.LeaveType.Id;
    ...
    return (
      <div className={styles.ungotiApplyLeave}>
        ...
        <Dialog open={this.state.showConfirm} className="applyLeaveDialog">
          ...
          {
            this.state.status == 'Rejected' ?            <Button variant="contained" disabled={this.state.disableresponse}  disableElevation color="primary" size="small" onClick={this.submit}>
            Reject
        </Button>:<Button variant="contained" disabled={this.state.disableresponse}  disableElevation color="primary" size="small" onClick={this.submit}>
              Approve
          </Button>
          }
